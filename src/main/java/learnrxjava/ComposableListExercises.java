...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    public static ComposableList<Integer> exercise8() {
        ...
        ComposableList<Integer> results = new ComposableListExercises<Integer>();
        results = newReleases.filter(video -> {
            return video.rating >= 5.0;
        }).map(video -> video.id);
        // ------------ INSERT CODE HERE! -----------------------------------
        return results; // Complete this expression
...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    */
    public static ComposableList<JSON> exercise12() {
                ...
                new MovieList(
                        ...
                        ComposableListExercises.of(
                                new Video(
                                        ...
                                        null,
                                        ComposableListExercises.of(
                                                new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/DieHard150" +
                                                        ".jpg")
                                        )),
                                new Video(
                                        654356453,
                                        ...
                                        null,
                                        ComposableListExercises.of(
                                                new BoxArt(200, 200, "http://cdn-0.nflximg.com/images/2891/BadBoys200" +
                                                        ".jpg"),
                                                new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/BadBoys150" +
                                                        ".jpg")
                                        ))
                        )
                ),
                new MovieList(
                        ...
                        ComposableListExercises.of(
                                new Video(
                                        ...
                                        null,
                                        ComposableListExercises.of(
                                                new BoxArt(150, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/TheChamber150.jpg")
                                        )),
                                new Video(
                                        675465,
                                        "Fracture",
                                        ...
                                        null,
                                        ComposableListExercises.of(
                                                new BoxArt(200, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture200.jpg"),
                                                new BoxArt(150, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture150.jpg"),
                                                new BoxArt(300, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture300.jpg")
                                        ))
                        )
                )
        );
        ...
        return movieLists.concatMap(movieList -> movieList.videos.concatMap(video -> video.boxarts.filter(boxArt ->
                boxArt.width == 150).map(boxArt -> json("id", video.id, "title", video.title, "boxart", boxArt.url))));
    }
        ...
        return videos.
                reduce(
                        ...
                        (accumulatedMap, video) -> {
                            ...
                            // only
                            // change objects created inside the function. That means that you cannot simply add the
                            // video to
                            // the accumulatedMap. You must make a copy of the accumulated map, and add the video
                            // title to that.
                            // Granted, this is very inefficient. However there are libraries that provide immutable
                            // maps to make
                            // copying maps very efficient, allowing this to be a viable approach. For the purpose of
                            // this
                            // exercise simply copy the accumulatedMap into a new map, add the video information to
                            // the copy,
                            // and return the copy.
                            // ************ INSERT CODE HERE ************
//                            throw new UnsupportedOperationException("Not implemented yet.");
    ...
    public static ComposableList<JSON> exercise19() {
                        ...
                        ComposableListExercises.of(
                                new Video(
                                        ...
                                        ComposableListExercises.of(
                                                new BoxArt(150, 200, "http://cdn-0.nflximg.com/images/2891/DieHard150" +
                                                        ".jpg"),
                                                new BoxArt(200, 200, "http://cdn-0.nflximg.com/images/2891/DieHard200" +
                                                        ".jpg")
                                        )),
                                new Video(
                                        654356453,
                                        ...
                                        ComposableListExercises.of(
                                                new BoxArt(200, 200, "http://cdn-0.nflximg.com/images/2891/BadBoys200" +
                                                        ".jpg"),
                                                new BoxArt(140, 200, "http://cdn-0.nflximg.com/images/2891/BadBoys140" +
                                                        ".jpg")
                                        ))
                        )
                ),
                new MovieList(
                        ...
                        ComposableListExercises.of(
                                new Video(
                                        ...
                                        null,
                                        ComposableListExercises.of(
                                                new BoxArt(130, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/TheChamber130.jpg"),
                                                new BoxArt(200, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/TheChamber200.jpg")
                                        )),
                                new Video(
                                        675465,
                                        "Fracture",
                                        ...
                                        ComposableListExercises.of(
                                                new BoxArt(200, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture200.jpg"),
                                                new BoxArt(120, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture120.jpg"),
                                                new BoxArt(300, 200, "http://cdn-0.nflximg" +
                                                        ".com/images/2891/Fracture300.jpg")
                                        ))
                        )
        ...
        // Use one or more concatMap, map, and reduce calls to create a list with the following items (order doesn't
        // matter)
        // [
        ...
        return movieLists.
                concatMap(movieList -> movieList.videos.map(video ->
                        json("id", video.id, "title", video.title, "boxart", video.boxarts.reduce((boxArt, boxArt2)
    ...
    */
    public static ComposableList<JSON> exercise20() {
        ...
        for (int counter = 0; counter < Math.min(videos.size(), bookmarks.size()); counter++) {
            ...
            videoIdAndBookmarkIdPairs.add(json("videoId", videos.get(counter).id, "bookmarkId", bookmarks.get
                    (counter).id));
        }
...
//        throw new UnsupportedOperationException("Not implemented yet.");
     ...
     */
    public static <T0, T1, R> ComposableList<R> zip(ComposableList<T0> left, ComposableList<T1> right, BiFunction<T0,
            T1, R> combinerFunction) {
...
//        throw new UnsupportedOperationException("Not implemented yet.");
    ...
    public static ComposableList<JSON> exercise22() {
        ...
        return ComposableListExercises.zip(bookmarks, videos, (bookmark, video) -> json("videoId", video.id,
...
//        return movieLists.
//            concatMap(movieList -> ComposableListExercises.zip(
//                    movieList.videos.filter(
//                            video -> video.boxarts.reduce(
//                                    (boxArt, boxArt2) ->
//                                            boxArt.height*boxArt.width > boxArt2.height*boxArt2
// .width?boxArt2:boxArt)),
//                    movieList.videos.map(video -> video.interestingMoments).filter(interestingMoments ->
// interestingMoments.)
//                    ));

        // Iteration - 1 - this does not get the smallest from EACH video, rather it gets only 2 entries
        // since it goes over EACH Movielist and there are 2 movielists.
//        ComposableList<BoxArt> e = movieLists.concatMap(movieList ->
//                movieList.videos.map(
//                        video -> video.boxarts.reduce(
//                                (boxArt, boxArt2) ->
//                                        boxArt.height * boxArt.width > boxArt2.height * boxArt2.width ? boxArt2 :
//                                                boxArt))
//                        .get(0));
        // Iteration - 2 - so this gets the smallest boxart, because of nested concatMap
//        ComposableList<BoxArt> e = movieLists.concatMap(movieList ->
//               movieList.videos.concatMap(video ->
//                       video.boxarts.reduce(
//                               (boxArt, boxArt2) ->
//                                       boxArt.width*boxArt.height>boxArt2.width*boxArt2.height?boxArt2:boxArt)));
        // Iteration - 3 get middle moments
//        ComposableList<InterestingMoment> e = movieLists.concatMap(movieList ->
//                movieList.videos.concatMap(video ->
//                        video.interestingMoments.filter
//                                (interestingMoment -> interestingMoment.type.equals("Middle"))));

        // Iteration - 4 - combine the above 2 lists into zip, but this does not have video
    ...
    */
    ...
    public <R> ComposableList<R> concatMap(
        ...
        for (T itemInList : this) {
            ...
            projectionFunctionThatReturnsList.apply(itemInList).forEach(r -> {
                results.add(r);
            });
            // ------------ INSERT CODE HERE! ----------------------------
