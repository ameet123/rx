...
//        return new ObservableSolutions();
    ...
    public void exerciseMovie() {
        ...
        assertTrue(map.containsKey(70111470));
        assertEquals("{boxart=http://cdn-0.nflximg.com/images/2891/DieHard150.jpg, id=70111470, title=Die Hard}", map
                .get(70111470).toString());
        assertTrue(map.containsKey(654356453));
        assertEquals("{boxart=http://cdn-0.nflximg.com/images/2891/BadBoys140.jpg, id=654356453, title=Bad Boys}",
                map.get(654356453).toString());
        assertTrue(map.containsKey(65432445));
        assertEquals("{boxart=http://cdn-0.nflximg.com/images/2891/TheChamber130.jpg, id=65432445, title=The " +
                "Chamber}", map.get(65432445).toString());
        assertTrue(map.containsKey(675465));
        assertEquals("{boxart=http://cdn-0.nflximg.com/images/2891/Fracture120.jpg, id=675465, title=Fracture}", map
                .get(675465).toString());
    }
